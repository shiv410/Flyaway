...
<body>
	...
	<form action="showdetails.jsp" method="post">
		...
		<p>
			Destination: <input type="text" name="destination" list="destination"
				required />
		...
		Passenger Name
		<%=i%>
		: <input type="text" name="fullname" required> </br> </br> Aadhar UID
		<%=i%>
		: <input type="number" name="uid" required></br> </br> Phone Number
		<%=i%>
		: <input type="number" name="phone" required> </br> </br> Age
		<%=i%>
